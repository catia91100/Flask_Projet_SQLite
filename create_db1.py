...
connection = sqlite3.connect('database.db1')
...
cur.execute("INSERT INTO emprunts (id_clients, id_livres, date_emprunt, date_retour) VALUES (?, ?, ?, ?)",('1', '3', '01/01/2024, '13/01/2024'))
cur.execute("INSERT INTO emprunts (id_clients, id_livres, date_emprunt, date_retour) VALUES (?, ?, ?, ?)",('2', '1', '04/01/2024, '14/01/2024'))
cur.execute("INSERT INTO emprunts (id_clients, id_livres, date_emprunt, date_retour) VALUES (?, ?, ?, ?)",('3', '2', '04/01/2024, '14/01/2024'))
connection.commit()
connection.close()
